...
def produce_prof(sngrp, red, cn, snapn, prop, hostid):
	...
	fahf = glob.glob('/home2/weiguang/The300/data/catalogues/AHF/GadgetX/%s/GadgetX-%s.%s.z*.AHF_halos' %(cn,cn,snapn))
...
def main():
	...
	h5fname="/home2/qingyang/GadgetX_prof/data/G3X-profiles-progenitors_galrr.hdf5"
