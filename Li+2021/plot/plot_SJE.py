...
def main():
	...
	mc_all(loc,dataCM,datafit,col = 'brown')
...
def Main():
	...
	gas_patch = Patch(edgecolor='brown', label='SJE',facecolor='white')
	...
	plt.tight_layout()
	plt.savefig('/Users/liqy/Desktop/figs_Trueini/overall_SJE.pdf')
	# plt.savefig('/Users/liqy/Desktop/sub_SJE.pdf')
	plt.show()
